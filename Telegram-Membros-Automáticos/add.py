'''
================Diórger Bretas===========================
Script para copiar e adicionar membros entre grupos
Trabalho desenvolvido para João I. pelo site vinte pila
*********************************************************
'''
...
def banner():
    ...
    print(f'{lg}Version: {w}2.0{lg} | Author: {w}Diórger{rs}')
